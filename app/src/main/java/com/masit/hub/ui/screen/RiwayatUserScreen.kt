...
fun RiwayatUserScreen(
    ...
    val selesaiList by remember { derivedStateOf { AppState.getSelesaiForUser() } }
    ...
    Scaffold(
        ...
        bottomBar = { BottomNavUser(selectedTab = 1, onHome = onHome, onRiwayat = {}) }
    ) { innerPadding ->
        LazyColumn(
            ...
            if (sortedList.isEmpty()) {
                item {
                    EmptyState(
                        ...
                        subtitle = "Aduan yang sudah selesai\nakan tampil di sini"
                    )
                }
            } else {
...
fun RiwayatUserScreenPreview() {
    MasITTheme { RiwayatUserScreen(onHome = {}, onDetailAduan = {}, onProfil = {}) }
}
